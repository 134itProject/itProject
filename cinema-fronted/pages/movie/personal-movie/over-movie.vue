<template>
	...
	<div v-if="movieinfolist.length===0">
		<div style="display: block;
			position: absolute;
			top:10%;
			left: 50%;
			transform: translate(-50%, -50%);">
		<image style="display: block; margin-top: 50vh;" src="//s1.hdslb.com/bfs/static/jinkela/long/bitmap/error_01.png"></image>
		<div style="color: #a0a0a0;
    text-align: center;">
		            <span>Σ(oﾟдﾟoﾉ) 空空如也！~</span>
		        </div>
		</div>
	</div>
	<div v-else>
