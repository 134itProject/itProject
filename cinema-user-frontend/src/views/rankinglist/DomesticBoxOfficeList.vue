<template>
  <div class="box-office-list">
    <div class="movie-item" v-for="(item, index) in domesticBoxOfficeList" :key="item.movieId">
    ...
    <div class="empty-state" v-if="domesticBoxOfficeList.length === 0">
