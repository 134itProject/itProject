      ...
      <div class="header-inner">
        <a href="/welcome" style="text-decoration: none;">
          ...
          <div style="color: #efe8e8; font-size: 26px;margin-top: 20px;">
            <img style="height: 30px; margin-bottom: -5px;" src="../assets/homeLogo.jpg">
            <span style="color: rgba(67,52,166,0.71)">电影院</span>
          </div>
        </a>
        <el-menu
        ...
        <div class="searchContainer">
          ...
          <el-button id="searchBtn" icon="iconfont el-icon-search" type="danger" circle @click="search"></el-button>
        </div>
