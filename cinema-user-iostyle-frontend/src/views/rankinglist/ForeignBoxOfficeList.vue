<template>
  <div class="box-office-list">
    <div class="movie-item" v-for="(item, index) in foreignBoxOfficeList" :key="item.movieId">
    ...
    <div class="empty-state" v-if="foreignBoxOfficeList.length === 0">
